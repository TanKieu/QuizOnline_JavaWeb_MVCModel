...
public class AddQuestionServlet extends HttpServlet {
    private final String SUCCESS_PAGE="addSuccess";
    private final String ADD_FAIL="addError";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            session.setAttribute("CREATEERRORS", errors);
         
        } catch (SQLException ex) {
            if(ex.getMessage().contains("duplicate")){
                errors.setQuestionIDError("Question ID is alrady existed");
                session.setAttribute("CREATEERRORS", errors);
            }
            log("AddQuestionServlet_SQLException "+ex.getMessage());
        } catch (NamingException ex) {
            log("AddQuestionServlet_NamingException "+ex.getMessage());
        }finally{
